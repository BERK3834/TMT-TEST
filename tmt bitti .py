...
class TrailMakingTest:
    ...
    def start_test(self):
        ...
        tk.Label(self.root, text="Hangi Bölümü Yapmak İstiyorsunuz?", font=("Arial", 16, "bold"), fg="white", bg="black").pack(pady=10)
        
        tk.Button(self.root, text="Part A", font=("Arial", 14), bg="gray", fg="white", 
                  command=lambda: self.start_part(part="A")).pack(pady=5)
        tk.Button(self.root, text="Part B", font=("Arial", 14), bg="gray", fg="white", 
                  command=lambda: self.start_part(part="B")).pack(pady=5)
        tk.Button(self.root, text="Geri", font=("Arial", 14), bg="gray", fg="white", 
                  command=self.start_screen).pack(pady=5)
    ...
    def check_selection(self, value, part):
        ...
        if value == expected:
            ...
            if part == "A" and self.current_step > 1:
